{ pkgs, ... }:
let
  xrhardwareRules = pkgs.writeTextFile {
    name = "xrhardware-rules";
    text = ''
      ...
      # HTC Vive Pro Eye (Tobii Eye Chip) - USB
      ATTRS{idVendor}=="2104", ATTRS{idProduct}=="020f", TAG+="uaccess", ENV{ID_xrhardware}="1"
      ...
      # Xreal Air 2 Ultra - USB
      ATTRS{idVendor}=="3318", ATTRS{idProduct}=="0426", TAG+="uaccess", ENV{ID_xrhardware}="1"
